...
<body>
	...
	<?php
	$sql_tampil = "select * from tb_pdd where status='Pindah' and id_pend ='$id'";
	...
	?>
		...
		<p>Telah benar-benar Pindah dari Kelurahan Watang Soreang, Kecamatan Soreang, Kabupuaten Parepare.
